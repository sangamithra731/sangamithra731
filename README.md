...
class Sangamithra:
    def __init__(self):
        ...
        self.cgpa        = 9.0
        self.stack       = ["Java", "Python", "C", "C++", "HTML"]
...
<div align="center">
  <img src="https://i.pinimg.com/736x/64/e4/25/64e425bf959ebdfa33ca788ed4b47fef.jpg?username=sangamithra731&theme=tokyonight&no-frame=true&no-bg=true&row=1&column=7&margin-w=4" alt="Trophies"/>
</div>
...
- 🤝 Collaborated in small development teams for coding, code review, and debugging sessions
- 💡 Consistently practised algorithmic **problem-solving** on LeetCode to sharpen coding skills
...
| ☁️ | **Salesforce Administrator Explore** | Completed Salesforce Administrator Explore certification |
| 💻 | **LeetCode Problem Solving** | Consistent practice on LeetCode — data structures & algorithms challenges |
| 📚 | **Library System** | Managed **50+ book records** in a CLI-based Python application |
| 🏧 | **ATM Simulator** | Processed **100+ transactions** ensuring accurate real-time balance updates |
...
🐍 Python Deep Dive     → File I/O, OOP Patterns, Libraries
🌐 Web Development      → CSS, JavaScript, Responsive Design
🔗 Data Structures      → Trees, Graphs, Dynamic Programming
☁️  Cloud Basics         → AWS Fundamentals, Cloud Concepts
📦 Version Control      → GitHub Actions, Branching Strategies
```
